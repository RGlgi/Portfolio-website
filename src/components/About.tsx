  ...
  <div className="p-8 max-w-3xl mx-auto text-white">
    ...
    <div className="bg-white/10 p-6 rounded-lg shadow-md text-sm sm:text-base leading-relaxed text-gray-200">
      ...
      <p className="mb-4">
        ...
        modern technologies like React and Tailwind CSS. My recent projects
        include educational platforms and e-commerce interfaces that focus on
        performance, usability, and design clarity.
      </p>
      <p>
        I’m committed to continuous learning, clean code, and delivering
